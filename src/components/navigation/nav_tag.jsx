...
const NavTag = ({ Icon, Tag, to, children }) => {
    const location = useLocation();
    const isActive = location.pathname === to;

    return (
        <li className={`relative transition ease-in-out hover:bg-gray-300 hover:text-[#333] dark:hover:bg-gray-700 dark:hover:text-[#fff] ${isActive ? 'bg-gray-300 text-[#333] dark:bg-gray-700 dark:text-[#fff]' : ''}`}>
