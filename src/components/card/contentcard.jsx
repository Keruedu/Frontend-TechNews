...
const ContentCard = ({
  ...
  return (
    <>
      <div
        className={`relative flex flex-col p-4 rounded-2xl w-full md:w-1/3 min-w-[262px] h-[386px] md:max-w-[318.4px] border bg-slate-100 text-gray-800 border-gray-400 dark:bg-gray-800 dark:text-white dark:border-gray-700 hover:border-gray-600 ${isSelected ? 'border-blue-500' : ''}`}
